<template>
  <div>
    <div class="search">
      <el-input placeholder="请输入类别查询" style="width: 200px" v-model="name"></el-input>
    ...
    <el-dialog title="博客分类" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
