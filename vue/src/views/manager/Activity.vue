        ...
        <el-table-column label="活动内容">
          <template v-slot="scope">
            <div style="align-content: center">
              <el-button @click="preview(scope.row.content)">活动详情
              </el-button>
            </div>
...
<!--form表单-->
    ...
    <!--文章内容弹窗-->
    <el-dialog title="活动详情" :visible.sync="fromVisible1" width="50%" :close-on-click-modal="true" destroy-on-close>
      <div class="w-e-text" >
